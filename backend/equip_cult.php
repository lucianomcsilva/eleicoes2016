<?php
   ...
   $sql = "select  cd_path, vl_equip_cult from equip_cult dg inner join bairros_graficos bg on bg.CD_BAIRRO = dg.cd_bairro;";
   ...
   for($i = 0; $i < $rs->num_rows; $i++)
   {
      ...
      $row = $rs->fetch_array();
      $content[$i] = Array($row['cd_path'], $row['vl_equip_cult']);
   };
