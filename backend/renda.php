<?php
   ...
   $sql = "select  cd_path, vl_renda from dados_demograficos dg inner join bairros_graficos bg on bg.CD_BAIRRO = dg.cd_bairro;";
   ...
   for($i = 0; $i < $rs->num_rows; $i++)
   {
      ...
      $row = $rs->fetch_array();
      $content[$i] = Array($row['cd_path'], $row['vl_renda']);
   };
